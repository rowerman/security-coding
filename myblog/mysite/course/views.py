...
def edit_course(request,course_id):
    ...
    if request.method == "POST":
        ...
        if course_form.is_valid():
            course_cd = course_form.cleaned_data
            course.title = course_cd["title"]
            course.overview = course_cd["overview"]
            course.save()
        return HttpResponseRedirect('/course/manage-course')
    else:
        course_form = CreateCourseForm(initial={"title":course.title,"overview":course.overview})
        return render(request,"course/manage/edit_course.html",{"course_form":course_form})
